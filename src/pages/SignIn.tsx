    ...
    <div className="min-h-screen flex bg-white dark:bg-gray-900">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="auth-slide-up" style={{ animationDelay: '0.3s' }}>
              <div className="flex items-center justify-between mb-1">
                <label className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Password</label>
          ...
          <p className="text-center text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-4 auth-fade-in" style={{ animationDelay: '0.55s' }}>
